...
import { ZLICX_DOMAINS } from "@zlicx/utils";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <InfoTooltip
                content={
                  <TooltipContent
                    title="Learn more about how to add, configure, and verify custom domains on Zlicx."
                    href="https://zlicx.com/help/category/custom-domains"
                    target="_blank"
                    cta="Learn more"
                  />
                }
