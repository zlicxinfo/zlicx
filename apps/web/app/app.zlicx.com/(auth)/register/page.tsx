import { BlurImage, Button, Logo } from "@zlicx/ui";
import { HOME_DOMAIN, constructMetadata } from "@zlicx/utils";
  ...
  return (
    <div className="grid w-full grid-cols-1 md:grid-cols-3">
      ...
      {/* <div className="hidden h-full flex-col justify-center space-y-12 overflow-hidden border-l border-gray-200 bg-white/10 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur md:flex">
        <a
          href="https://zlicx.com/features/analytics"
          target="_blank"
          className="ml-12 h-1/2 w-[150%] rounded-xl border border-gray-200 bg-white/90 p-4 shadow-xl"
        >
          <BlurImage
            alt="zlicx.com Analytics"
            src="https://assets.zlicx.com/features/analytics.png"
            width={1735}
            height={990}
        ...
        <a
          href="https://zlicx.com/customers"
          target="_blank"
        ...
        >
          {logos.map((logo, idx) => (
            <BlurImage
              alt={`${logo} logo`}
              key={idx}
              src={`https://zlicx.com/_static/clients/${logo}.svg`}
              width={520}
              height={182}
