...
import { Button, Github, Google, InfoTooltip, useMediaQuery } from "@zlicx/ui";
        ...
        {showSSOOption && (
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <InfoTooltip
                content={`This is your workspace's unique identifier on ${process.env.NEXT_PUBLIC_APP_NAME}. E.g. app.zlicx.com/acme is "acme".`}
              />
            </div>
            <input
              id="slug"
