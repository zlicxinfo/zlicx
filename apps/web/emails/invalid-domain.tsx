        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              <Link
                href={`https://app.zlicx.com/${workspaceSlug}`}
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              automatically deleted from zlicx.com. Please click the link below to
              configure your domain.
            </Text>
            <Section className="my-8 text-center">
              <Link
                className="rounded-full bg-black px-6 py-3 text-center text-[12px] font-semibold text-white no-underline"
                href={`https://app.zlicx.com/${workspaceSlug}/domains`}
              >
                Configure domain
              </Link>
            </Section>
            <Text className="text-sm leading-6 text-black">
              If you do not want to keep this domain on zlicx.com, you can{" "}
              <Link
                href={`https://app.zlicx.com/${workspaceSlug}/domains`}
                className="font-medium text-blue-600 no-underline"
              >
