import { ZLICX_LOGO, capitalize, getNextPlan, nFormatter } from "@zlicx/utils";
import {
  Body,
  Container,
  Head,
...
export default function LinksLimitAlert({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your Zlicx workspace, {name} has used {percentage.toString()}% of its
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
              zlicx.com Links Limit Alert
            </Heading>
            <Text className="text-sm leading-6 text-black">
              Your zlicx.com workspace,{" "}
              <Link
                href={`https://app.zlicx.com/${slug}`}
            ...
            <Section className="mb-8 text-center">
              <Link
                ...
                href={`https://app.zlicx.com/${slug}?upgrade=${nextPlan.name.toLowerCase()}}`}
              >
                Upgrade my plan
              </Link>
            </Section>
