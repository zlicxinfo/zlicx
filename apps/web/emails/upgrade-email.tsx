import { ZLICX_LOGO, getPlanDetails } from "@zlicx/utils";
import {
  Body,
  Container,
  Head,
...
export default function UpgradeEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Thank you for upgrading to zlicx.com {plan}!</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
              Thank you for upgrading to zlicx.com {plan}!
            </Heading>
            ...
            <Text className="text-sm leading-6 text-black">
              My name is Anandhan, and I'm the founder of Zlicx. I wanted to
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              to build and improve zlicx.com.
            </Text>
            <Text className="text-sm leading-6 text-black">
