...
/* 
  ...
  1. Workspace analytics page, e.g. app.zlicx.com/zlicx/analytics
  2. Public stats page, e.g. zlicx.com/stats/github, stey.me/stats/weathergpt
*/
...
export default function Analytics({
  ...
  const { basePath, domain, baseApiPath } = useMemo(() => {
    if (admin) {
      ...
      // Public stats page, e.g. zlicx.com/stats/github, stey.me/stats/weathergpt
      return {
        basePath: `/stats/${key}`,
  ...
  return (
    <AnalyticsContext.Provider
      value={{
        ...
        queryString,
        domain: domain || undefined, // domain for the link (e.g. zli.cx, stey.me, etc.)
