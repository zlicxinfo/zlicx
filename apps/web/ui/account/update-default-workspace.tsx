...
import { Button, InputSelect, InputSelectItemProps } from "@zlicx/ui";
import { DICEBEAR_AVATAR_URL } from "@zlicx/utils";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between space-x-4 rounded-b-lg border-t border-gray-200 bg-gray-50 p-3 sm:px-10">
        <a
          href="https://zlicx.com/help/article/how-to-change-default-workspace"
          target="_blank"
