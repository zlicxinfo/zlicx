...
import { Label, RadioGroup, RadioGroupItem, useMediaQuery } from "@zlicx/ui";
import { InfoTooltip } from "@zlicx/ui/src/tooltip";
import {
    ...
    <>
      ...
      {domainError &&
        (domainError === "Domain is already in use." ? (
          <p className="mt-2 text-sm text-red-600" id="domain-error">
            ...
            <a
              className="underline"
              href="mailto:support@zlicx.com?subject=My Domain Is Already In Use"
            >
              Contact us
            </a>{" "}
      ...
      {(domain.includes("/") || domainType === "website") && (
        <p className="mt-2 text-sm text-gray-500">
          Want to set up zlicx.com to handle redirects on a subpath instead?{" "}
          <a
            href="https://zlicx.com/help/article/how-to-use-zlicx-with-subpath"
            target="_blank"
            className="underline"
          >
            Read this guide.
