...
import { LoadingSpinner, SimpleTooltipContent, Switch } from "@zlicx/ui";
import { BadgeTooltip } from "@zlicx/ui/src/tooltip";
          ...
          <BadgeTooltip
            content={
              <SimpleTooltipContent
                ...
                cta="Learn more."
                href="https://zlicx.com/help/article/conversion-tracking"
              />
            }
          >
        ...
        {data &&
          (data.installed ? (
            ...
            <p className="text-sm text-gray-600">
              ...
              <a
                href="https://github.com/zlicx-info/analytics"
                target="_blank"
