...
import { SAML_PROVIDERS } from "@zlicx/utils";
      ...
      <div className="flex flex-col space-y-6 bg-gray-50 px-4 py-8 text-left sm:px-16">
        ...
        >
          <div>
            ...
            {currentProvider ? (
              <a
                href={`https://zlicx.com/help/article/${selectedProvider}-saml`}
                target="_blank"
              ...
              <a
                href="https://zlicx.com/help/category/saml-sso"
                target="_blank"
                className="ml-2 mt-2 block text-sm text-gray-500 underline"
              >
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={`Your ${currentProvider.samlModalCopy} is the URL to your SAML provider's metadata.`}
                        cta="Learn more."
                        href={`https://zlicx.com/help/article/${selectedProvider}-saml#step-4-copy-the-metadata-url`}
                      />
                    }
                  />
                </div>
