  ...
  const qrData = useMemo(
    () => ({
      ...
      ...(showLogo && {
        imageSettings: {
          src:
            logo && plan !== "free" ? logo : "https://zlicx.com/_static/logo.svg",
          height: 256,
          width: 256,
          excavate: true,
        },
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(
                    `https://api.zlicx.com/qr?url=${linkConstructor({
                      key: props.key,
                      domain: props.domain,
                      searchParams: {
                        qr: "1",
                      ...
                      ...(qrData.imageSettings && {
                        imageSettings: {
                          ...
                          src:
                            logo && plan !== "free"
                              ? logo
                              : "https://zlicx.com/_static/logo.svg",
                        },
                      }),
                    }),
                    "svg",
                ...
                <InfoTooltip
                  content={
                    <SimpleTooltipContent
                      ...
                      href="https://zlicx.com/help/article/custom-qr-codes"
                    />
                  }
                />
              )}
