...
import { Crosshairs, CursorRays, InvoiceDollar } from "@zlicx/ui/src/icons";
import { LinkifyTooltipContent } from "@zlicx/ui/src/tooltip";
import {
  cn,
  fetcher,
  getApexDomain,
                ...
                <Tooltip
                  content={
                    <SimpleTooltipContent
                      ...
                      cta="Learn more."
                      href="https://zlicx.com/help/article/link-cloaking"
                    />
                  }
                >
                ...
                <Tooltip
                  content={
                    <SimpleTooltipContent
                      ...
                      cta="Learn more."
                      href="https://zlicx.com/help/article/password-protected-links"
                    />
                  }
                >
                    ...
                    {...(!isZlicxDomain(domain) && {
                      disabledTooltip: (
                        <SimpleTooltipContent
                          ...
                          cta="Learn more."
                          href="https://zlicx.com/help/article/how-to-transfer-domains"
                        />
                      ),
                    })}
                  />
