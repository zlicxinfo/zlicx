      ...
      {isMigratedWorkspace && (
        <>
          ...
          <div className="absolute -bottom-28 right-0 z-10 w-full max-w-[16rem] rounded-lg border border-gray-200 bg-white p-3 text-center text-sm shadow lg:-right-56">
            <p>
              Your <InlineSnippet>zli.cx</InlineSnippet> links have been
              migrated to a custom workspace.
            </p>
            <a
              href="https://zlicx.com/changelog/zlicx-links-updates"
              target="_blank"
                  ...
                  <Tooltip
                    content={
                      <DomainsTooltip
                        ...
                        title={
                          domains.length === 0
                            ? "No domains added yet – currently using Zlicx default domains."
                            : verified === false
