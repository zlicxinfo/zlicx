...
import { COUNTRY_CODES, capitalize } from "@zlicx/utils";
...
export const analyticsQuerySchema = z.object({
  ...
  linkId: z
    .string()
    .optional()
    .describe("The unique ID of the short link on Zlicx."),
  externalId: z
    .string()
    .optional()
    .describe(
  ...
  start: parseDateSchema
    .refine(
      (value: Date) => {
        const foundingDate = new Date("2022-09-22T00:00:00.000Z"); // zlicx.com founding date
