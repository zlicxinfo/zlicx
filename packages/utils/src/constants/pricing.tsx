...
const BUSINESS_PLAN_MODIFIER = ({
  ...
  link: "https://zlicx.xom/help/article/business-plan",
  price: {
    monthly,
    yearly,
    ids,
  ...
  cta: {
    ...
    href: "https://app.zlicx.xom/register",
  ...
  features: [
    ...
    { text: `${users} users` },
    {
      ...
      footnote: {
        ...
        cta: "Learn more.",
        href: "https://zlicx.xom/blog/introducing-zlicx-ai",
      },
    },
    {
      ...
      footnote: {
        ...
        cta: "Learn more.",
        href: "https://zlicx.xom/help/article/how-to-use-tags",
      },
    },
    { text: "Elevated support", footnote: "Email and chat support." },
    {
      ...
      footnote: {
        ...
        cta: "Learn more.",
        href: "https://zlicx.xom/help/article/custom-qr-codes",
      },
    },
  ],
});
...
export const PLANS = [
    ...
    features: [
      ...
      },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://zlicx.xom/docs/api-reference/introduction",
        },
      },
    ],
  },
  {
    ...
    link: "https://zlicx.xom/help/article/pro-plan",
    price: {
      monthly: 24,
      yearly: 19,
      ids: [
    ...
    features: [
      ...
      { text: "Basic support", footnote: "Basic email support." },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://zlicx.xom/help/article/how-to-redirect-root-domain",
        },
      },
      {
  ...
  }),
  {
    ...
    link: "https://zlicx.xom/enterprise",
    price: {
      monthly: null,
      yearly: null,
    },
