...
export function Footer() {
  ...
  const createHref = (href: string) =>
    domain === "zlicx.com" ? href : `https://zlicx.com${href}`;
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a
                href="https://github.com/zlicx-info/zlicx"
                target="_blank"
                rel="noreferrer"
                className="group rounded-full border border-gray-200 p-2 transition-colors hover:bg-gray-100"
              >
              ...
              <a
                href="https://www.linkedin.com/company/zlicx"
                target="_blank"
                rel="noreferrer"
                className="group rounded-full border border-gray-200 p-2 transition-colors hover:bg-gray-100"
              >
...
function StatusBadge() {
  ...
  }>("https://status.zlicx.com/api/v1/summary", fetcher);
